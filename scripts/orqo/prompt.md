...
You will work on the AFK issues only, not the HITL (Human-in-the-loop) ones.
...
- `npm run test` or `npx playwright test` to run the tests
- `npm run build` to run the type checker and build process
